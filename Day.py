...
while True:
	try:
		...
		copyfile('{}/Data/history_db.csv'.format(PATH), '{}/Data/history_db_TEMP.csv'.format(PATH))
		loggr.info("Extracting Yesterday's recorded data "\
			"(using ETL_history.py)...")
		import ETL_history
		break
		...
		# attempt
		copyfile('{}/Data/history_db_TEMP.csv'.format(PATH), '{}/Data/history_db.csv'.format(PATH))
		time.sleep(10)
		continue
...
try:
	...
	copyfile('{}/Data/master_db.csv'.format(PATH), '/Users/Alex/Dropbox (Personal)/master_db.csv')
except Exception as e:
