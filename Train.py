...
def train(time_span=100,**kwargs):
    ...
    def get_time_span_indices(today):
        ...
        # Set interval to jump for getting dates at extremities of time span
        date_jump = int(time_span / 2)

        # Convert date into datetome format for calculations purposes
        ...
        while True:
            try:
                ...
                break
                    ...
                    date_jump -= 1
        loggr.info('selected start date and end date for ' +
                   'time span: {} -> {}'.format(start_date, end_date))
